...
simConfig.analysis['plotRaster'] = {'orderInverse': True, 'saveFig': '/users/k1926552/Documents/FINAL/netpyne-project/KonstantoudakiEtAl2014/experiment/Results1/raster.png','showFig':False}
simConfig.analysis['plotTraces'] = {'include': [('PYR_pop', [0]), ('FSin_pop', [0]), ('RSin_pop', [0]), ('ISin_pop', [0])],'oneFigPer': 'trace', 'overlay': False, 'saveFig': '/users/k1926552/Documents/FINAL/netpyne-project/KonstantoudakiEtAl2014/experiment/Results1/traces.png','showFig':False}
simConfig.analysis['plotSpikeStats'] = {'saveFig': '/users/k1926552/Documents/FINAL/netpyne-project/KonstantoudakiEtAl2014/experiment/Results1/spike-stats.png','showFig':False}

simConfig.analysis['plotConn'] = {'groupBy': 'cell', 'saveFig':'/users/k1926552/Documents/FINAL/netpyne-project/KonstantoudakiEtAl2014/experiment/Results1/conn.png','showFig':False}
